<?php
// Creating the widget 
class RECOMMENDED_POSTS_WIDGET extends WP_Widget {

	const WIDGET_DOMAIN = '_s';
	const WIDGET_ID = 'recommended-posts';
	const WIDGET_NAME = 'Syndrome Blog - Recommended Posts';
	const WIDGET_DESCRIPTION = 'Custom widget for recommended posts.';
	const WIDGET_TITLE = 'Recommended';
...
add_action( 'widgets_init', create_function( '', "register_widget('RECOMMENDED_POSTS_WIDGET');" ) );