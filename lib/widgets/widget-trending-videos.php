<?php
// Creating the widget 
class TRENDING_VIDEOS_WIDGET extends WP_Widget {

	const WIDGET_DOMAIN = '_s';
	const WIDGET_ID = 'trending-videos';
	const WIDGET_NAME = 'Syndrome Blog - Trending Videos';
	const WIDGET_DESCRIPTION = 'Custom widget for trending videos.';
...
add_action( 'widgets_init', create_function( '', "register_widget('TRENDING_VIDEOS_WIDGET');" ) );